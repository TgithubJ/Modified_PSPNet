...
class Dilated_ResNet_101(Network):
    def setup(self, is_training):
        ...
        (self.feed('res5b_relu', 
             ...
             # .atrous_conv(3, 3, 2048, 1, padding='SAME', relu=False, name='fc1_voc12_c0'))

        # (self.feed('res5c_relu')
        #      .atrous_conv(3, 3, 2048, 12, padding='SAME', relu=False, name='fc1_voc12_c1'))

        # (self.feed('res5c_relu')
        #      .atrous_conv(3, 3, 2048, 18, padding='SAME', relu=False, name='fc1_voc12_c2'))

        # (self.feed('res5c_relu')
        #      .atrous_conv(3, 3, 2048, 24, padding='SAME', relu=False, name='fc1_voc12_c3'))
...
class Dilated_ResNet_101_SSPS(Network):
    def setup(self, is_training):
        '''Network definition.
        ...
        (self.feed('res5b_relu', 
             ...
             .add(name='res5c')
             .relu(name='res5c_relu')
             .atrous_conv(3, 3, 2048, 6, padding='SAME', relu=False, name='fc1_voc12_c0'))
