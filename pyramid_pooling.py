...
def pyramid_pooling_module(inputs, original_HW):    
    pyramid1 = pyramid_pooling(inputs, (8, 8), 512, original_HW)
    pyramid2 = pyramid_pooling(inputs, (16, 16), 512, original_HW)
    pyramid3 = pyramid_pooling(inputs, (32, 32), 512, original_HW)
    pyramid4 = pyramid_pooling(inputs, (64, 64), 512, original_HW)
