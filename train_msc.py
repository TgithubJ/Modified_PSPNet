...
SNAPSHOT_DIR = '../../../data/redbull_ckpt/20170706'
WEIGHT_DECAY = 0.0001
CROP_SIZE = 512
SCALE_SIZE = 544
...
def main():
    ...
    print('net.layers[res5c_relu]:', net.layers['res5c_relu'].shape)

    with tf.name_scope("psp"):
        pooled_output = pp.pyramid_pooling_module(res_output, original_HW=(CROP_SIZE/8, CROP_SIZE/8))
